...
SCHEMAS = [
    ...
    WorksheetSchema(
        ...
        ["voice_female_1", "TRUE", "google", "google", "vi-VN", "vi-VN", "vi-VN-Wavenet-A", "FEMALE", "1.0", "1.0", "0", "0", "", "", ""],
    ),
    WorksheetSchema(
        "MUSIC_PACK",
    ...
    WorksheetSchema(
        ...
        ["job_001", "NEW", "kenh_1", "runtime/test/test.mp4", "", "", "", "Sample title", "Sample description", "test,upload", "22", "private", "", "pending", "", "", "", "0", "", "", "", "Original title", "", "", "", "", "", ""],
    ),
    WorksheetSchema(
        "UPLOADED_VIDEOS",
        [
